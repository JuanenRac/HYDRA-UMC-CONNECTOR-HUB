...
# *****************************************************************************
# Project   : HYDRA-UMC-CONNECTOR-HUB
# Script    : build.sh
...
printf '\n*******************************************************************************\n'
printf '%s\n' "* HYDRA-UMC-CONNECTOR-HUB - build.sh"
...
# Builds HYDRA-UMC-CONNECTOR-HUB: creates/activates a venv, installs the
...
python -m py_compile src/hydra_umc_connector_hub/__init__.py src/hydra_umc_connector_hub/schema.py src/hydra_umc_connector_hub/cli.py
python -c "import hydra_umc_connector_hub; print('import OK - version', hydra_umc_connector_hub.__version__)"
echo "      Done."
echo
...
echo " ==============================================================="
echo "  Build complete. Run ./run.sh to validate the ten real fixtures."
echo " ==============================================================="
echo
