#!/usr/bin/env python3
# =============================================================================
# HYDRA-UMC-CONNECTOR-HUB - bump_version.py
# Copyright (C) 2026 JuanenRac (Electro Hobby 3D) <electrohobby3d@gmail.com>
# GPL-3.0 - see LICENSE
#
# Applies the ecosystem-wide "odometer" version bump to this project's own
# pyproject.toml (and its mirrored src/hydra_umc_connector_hub/__init__.py)
...
INIT_FILE = ROOT / "src" / "hydra_umc_connector_hub" / "__init__.py"
