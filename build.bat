...
echo.
echo *****************************************************************************
echo * HYDRA-UMC-CONNECTOR-HUB - build.bat
...
REM Builds HYDRA-UMC-CONNECTOR-HUB: creates/activates a venv, installs the
...
echo  ===============================================================
echo   Build complete. Run run.bat to validate the ten real fixtures.
echo  ===============================================================
echo.
pause
exit /b 0
